...
namespace eStore.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> Index(string search, int? page)
        {
            ...
            IEnumerable<Account> members = memberRepository.GetMembersList().OrderByDescending(mem => mem.Fullname);
            ...
            return View(await PaginatedList<Account>.CreateAsync(members.AsQueryable(), page ?? 1, pageSize)) ;
        }
        ...
        public ActionResult Details(int? id)
        {
            try
            {
                ...
                Account member = memberRepository.GetMember(id.Value);
                if (member == null)
                {
                    throw new Exception("Member ID is not found!!!");
                }
        ...
        public ActionResult Create(Account member, [FromForm] string confirm)
        {
            try
            {
                ...
                Account newMember = memberRepository.GetMember(member.Email);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Account member, [FromForm] string confirm)
        {
            try
            {
        ...
        public IActionResult Profile()
        {
            try
            {
                ...
                Account member = memberRepository.GetMember(int.Parse(strMemberId));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Profile(Account member, [FromForm] string confirm)
        {
