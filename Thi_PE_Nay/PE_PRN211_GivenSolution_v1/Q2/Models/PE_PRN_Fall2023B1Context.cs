...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server =DESKTOP-QO6QR2G\\SQLEXPRESS; database =PE_PRN_Fall2023B1;uid=sa;pwd=123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>(entity =>
            {
                ...
                entity.HasMany(d => d.Genres)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("MovieId", "GenreId").HasName("PK__Movie_Ge__BBEAC44D1AE8655C");
            ...
            modelBuilder.Entity<MovieStar>(entity =>
            {
                entity.HasKey(e => new { e.MovieId, e.StarId })
                    .HasName("PK__Movie_St__2BB8287CB3B4DF56");
